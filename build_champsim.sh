...
L1I_PREFETCHER=$(_extract_component_name $2 prefetcher l1i_pref)    # prefetcher/*.l1i_pref
L1D_PREFETCHER=$(_extract_component_name $3 prefetcher l1d_pref)    # prefetcher/*.l1d_pref
L2C_PREFETCHER=$(_extract_component_name $4 prefetcher l2c_pref)    # prefetcher/*.l2c_pref
LLC_PREFETCHER=$(_extract_component_name $5 prefetcher llc_pref)    # prefetcher/*.llc_pref
LLC_REPLACEMENT=$(_extract_component_name $6 replacement llc_repl)  # replacement/*.llc_repl
